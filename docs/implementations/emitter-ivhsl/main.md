...
This Instance has not been validated in Nucleus Cytosol $\ge$ v0.5. Documentation can be found on the legacy site [here](https://nucleus.bnext.bio/Emitter-Cells-144ae616eb518077aeb2d9d6768dd2f5). 
